...
import com.ouclbc.medialearningproject.Encoder;
import com.ouclbc.medialearningproject.R;
import com.ouclbc.medialearningproject.fragment.BackHandledFragment;
import com.ouclbc.medialearningproject.video.VideoEncodeConfig;
import com.ouclbc.medialearningproject.video.VideoEncoder;
...
/**
 * http://blog.csdn.net/keen_zuxwang/article/details/78191404
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
public class Camera2VideoFragment extends BackHandledFragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        VideoEncodeConfig videoEncodeConfig = new VideoEncodeConfig(1920, 1080, 10000000,
                30, 1, null, "video/avc", null);
        mVideoEncoder = new VideoEncoder(videoEncodeConfig);
    }
    ...
    private void initMediaCodec(/*String filePath*/){
        try {
            mMediaCodec = MediaCodec.createEncoderByType("video/avc");
            mMuxer = new MediaMuxer(getVideoFilePath(getActivity()), MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }
    ...
    private void resetVideoOutputFormat(MediaFormat newFormat) {
        ...
        Log.d(TAG, "resetVideoOutputFormat: mVideoTrackIndex="+mVideoTrackIndex);
    ...
    private void startRecordingVideo() {
        ...
        try {
            ...
            //setUpMediaRecorder();
            //initMediaCodec();
            String savePath = getVideoFilePath(getActivity());
            Log.d(TAG,"*****************save path is"+savePath);
            ...
            Surface recorderSurface = mVideoEncoder.getInputSurface();
